...
const quotePhrase =document.querySelector(".quote h4");
const quotewriter =document.querySelector(".quote span");

quotePhrase.innerText = quotes[random].quote;
quotewriter.innerText = quotes[random].author;